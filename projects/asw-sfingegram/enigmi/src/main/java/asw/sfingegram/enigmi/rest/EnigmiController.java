...
import asw.sfingegram.enigmi.domain.*;
...
public class EnigmiController {
	...
	public Enigma createEnigma(@RequestBody CreateEnigmaRequest request) {
		...
		logger.info("REST CALL: createEnigma " + autore + ", " + tipo + ", " + titolo + ", " + toString(testo) + ", " + toString(soluzione)); 
		Enigma enigma = enigmiService.createEnigma(autore, tipo, titolo, testo, soluzione);
		return enigma; 
	}	
